...
var resolvers = {
  ...
  Mutation: {
    ...
    updateMessage: function updateMessage(parent, _ref8, _ref9) {
      var id = _ref8.id,
          text = _ref8.text;
      var me = _ref9.me;

      var _messages3 = _messages,
          message = _messages3[id],
          otherMessages = _objectWithoutProperties(_messages3, [id].map(_toPropertyKey));
